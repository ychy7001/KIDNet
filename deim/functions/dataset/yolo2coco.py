...
# python dataset/yolo2coco.py --root_dir dataset/train --save_path data.json
# python dataset/yolo2coco.py --root_dir dataset/val --save_path data.json
# python dataset/yolo2coco.py --root_dir dataset/test --save_path data.json
